...
(function (App) {
    ...
    var ProjectState = (function (_super) {
        ...
        ProjectState.prototype.addProject = function (title, description, people) {
            var newProject = new App.Project(Math.random().toString(), title, description, people, App.ProjectStatus.Active);
    ...
    var ProjectList = (function (_super) {
        ...
        ProjectList.prototype.gatherProjects = function (projects) {
            ...
            this.assignedProjects = projects.filter(function (x) {
                if (_this.type === 'active') {
                    return x.status === App.ProjectStatus.Active;
                }
                return x.status === App.ProjectStatus.Finished;
            });
        };
        ProjectList.prototype.renderProjects = function () {
            ...
            this.assignedProjects.forEach(function (project) {
                new App.ProjectItem(_this.element.querySelector('ul').id, project);
            });
        };
        __decorate([
            App.Autobind
...
(function (App) {
    var ProjectInput = (function (_super) {
        ...
        ProjectInput.prototype.verifyUserInput = function (enteredTitle, enteredDescription, enteredPeople) {
            return (!App.validate({ value: enteredTitle, required: true, minLength: 5 }) ||
                !App.validate({
                ...
                !App.validate({ value: +enteredPeople, required: true, min: 1 }));
        };
